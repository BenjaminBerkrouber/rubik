...
============================================================================= */
    ...
    TEST_F(SpinBTest, SpinB) {
        ...
        EXPECT_EQ(cube.getCorners(), "0 1 3 7 4 5 2 6 ");
        EXPECT_EQ(cube.getEdges(), "0 1 7 3 4 5 2 10 8 9 6 11 ");
        EXPECT_EQ(cube.getCornerOrientations(), "0 0 2 1 0 0 1 2 ");
        EXPECT_EQ(cube.getEdgeOrientations(), "0 0 1 0 0 0 1 1 0 0 1 0 ");
    }
    ...
    TEST_F(SpinBTest, SpinB_Two) {
        ...
        EXPECT_EQ(cube.getCorners(), "0 1 7 6 4 5 3 2 ");
        EXPECT_EQ(cube.getEdges(), "0 1 10 3 4 5 7 6 8 9 2 11 ");
...
============================================================================= */
    ...
    TEST_F(SpinBTest, SpinB_PRIM) {
        ...
        EXPECT_EQ(cube.getCorners(), "0 1 6 2 4 5 7 3 ");
        EXPECT_EQ(cube.getEdges(), "0 1 6 3 4 5 10 2 8 9 7 11 ");
        EXPECT_EQ(cube.getCornerOrientations(), "0 0 2 1 0 0 1 2 ");
        EXPECT_EQ(cube.getEdgeOrientations(), "0 0 1 0 0 0 1 1 0 0 1 0 ");
    }
