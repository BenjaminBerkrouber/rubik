...
============================================================================= */
    ...
    TEST_F(SpinFTest, SpinF) {
        ...
        EXPECT_EQ(cube.getCorners(), (std::array<uint8_t, 8>{1, 5, 2, 3, 0, 4, 6, 7}));
        EXPECT_EQ(cube.getEdges(), (std::array<uint8_t, 12>{5, 1, 2, 3, 0, 8, 6, 7, 4, 9, 10, 11}));
        EXPECT_EQ(cube.getCornerOrientations(), (std::array<uint8_t, 8>{2, 1, 0, 0, 1, 2, 0, 0}));
        EXPECT_EQ(cube.getEdgeOrientations(), (std::array<uint8_t, 12>{1, 0, 0, 0, 1, 1, 0, 0, 1, 0, 0, 0}));
    }
    ...
    TEST_F(SpinFTest, SpinF_Two) {
        ...
        EXPECT_EQ(cube.getCorners(), (std::array<uint8_t, 8>{5, 4, 2, 3, 1, 0, 6, 7}));
        EXPECT_EQ(cube.getEdges(), (std::array<uint8_t, 12>{8, 1, 2, 3, 5, 4, 6, 7, 0, 9, 10, 11}));
...
============================================================================= */
    ...
    TEST_F(SpinFTest, SpinF_PRIM) {
        ...
        EXPECT_EQ(cube.getCorners(), (std::array<uint8_t, 8>{4, 0, 2, 3, 5, 1, 6, 7}));
        EXPECT_EQ(cube.getEdges(), (std::array<uint8_t, 12>{4, 1, 2, 3, 8, 0, 6, 7, 5, 9, 10, 11}));
        EXPECT_EQ(cube.getCornerOrientations(), (std::array<uint8_t, 8>{2, 1, 0, 0, 1, 2, 0, 0}));
        EXPECT_EQ(cube.getEdgeOrientations(), (std::array<uint8_t, 12>{1, 0, 0, 0, 1, 1, 0, 0, 1, 0, 0, 0}));
    }
